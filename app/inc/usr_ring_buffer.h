...
#ifndef __USR_RING_BUFFER_H_
#define __USR_RING_BUFFER_H_
...
/**
 * @brief	Return address the ring buffer
 * @param	RingBuff	: Pointer to ring buffer
 * @return	Address of the ring buffer pointer
 */
STATIC INLINE void *RingBuffer_GetAddr(RINGBUFF_T *RingBuff)
{
...
/**
 * @brief	Clear the ring buffer to empty
 * @return  Nothing
 */
